...
भाषा कोड (`ru`) के रूप में या उसके अंग्रेज़ी नाम (`russian`) से दी जा सकती है; जो मॉडल नहीं जानता उसे ट्रांसक्रिप्शन के बीच में विफल होने के बजाय `400` के साथ अस्वीकार किया जाता है। `GET /api/models` बताता है कि वह क्या जानता है।
